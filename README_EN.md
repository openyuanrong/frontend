...
- [yuanrong](https://atomgit.com/openeuler/yuanrong): Refers to the multi-language function runtime repository.
...
The yuanrong-frontend repository is an optional component that provides gateway capabilities for openYuanrong, supporting features like function creation and invocation.
